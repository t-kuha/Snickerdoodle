...
CONFIG.NUM_PORTS {1} \
  ...
  connect_bd_net -net ps7_FCLK_CLK0 [get_bd_pins ps7/FCLK_CLK0] [get_bd_pins ps_rst_0/slowest_sync_clk]
  connect_bd_net -net ps7_FCLK_CLK1 [get_bd_pins ps7/FCLK_CLK1] [get_bd_pins ps_rst_1/slowest_sync_clk]
  connect_bd_net -net ps7_FCLK_CLK2 [get_bd_pins ps7/FCLK_CLK2] [get_bd_pins ps_rst_2/slowest_sync_clk]
  connect_bd_net -net ps7_FCLK_CLK3 [get_bd_pins ps7/FCLK_CLK3] [get_bd_pins ps_rst_3/slowest_sync_clk]
  connect_bd_net -net ps7_FCLK_RESET0_N [get_bd_pins ps7/FCLK_RESET0_N] [get_bd_pins ps_rst_0/ext_reset_in] [get_bd_pins ps_rst_1/ext_reset_in] [get_bd_pins ps_rst_2/ext_reset_in] [get_bd_pins ps_rst_3/ext_reset_in]
